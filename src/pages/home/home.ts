...
export class HomePage {
  ...
  initializeTrain() {
    this.trains = [
      ...
      { id: 31, name: '31.Sarangan Ekspres' },
      { id: 32, name: '32.Sidomukti' },
      { id: 33, name: '33.Majapahit' },
      { id: 34, name: '34.Jayabaya' },
      { id: 35, name: '35.Jaka Tingkir' },
      { id: 36, name: '36.Menoreh' },
      { id: 37, name: '37.Bogowonto' },
      { id: 38, name: '38.Gajah Wong' },
      { id: 39, name: '39.Karakatau' },
      { id: 40, name: '40.Matarmaja' },
      { id: 41, name: '41.Gaya Baru Malam Selatan' },
      { id: 42, name: '42.Brantas' },
      { id: 43, name: '43.Kertajaya' },
      { id: 44, name: '44.Pasundan' },
      { id: 45, name: '45.Kahuripan' },
      { id: 46, name: '46.Bengawan' },
      { id: 47, name: '47.Progo' },
      { id: 48, name: '48.Logawa' },
      { id: 49, name: '49.Kuntojaya Utara' },
      { id: 50, name: '50.Sri Tanjung' },
      { id: 51, name: '51.Tawang Jaya' },
      { id: 52, name: '52.Kuntojaya Selatan' },
      { id: 53, name: '53.Tegal Arum' },
      { id: 54, name: '54.Tawang Alun' },
      { id: 55, name: '55.Tegal Ekspres' },
      { id: 56, name: '56.Maharani' },
      { id: 57, name: '57.Kalijaga' },
      { id: 58, name: '58.Probowangi' },
      { id: 59, name: '59.Serayu' },
      { id: 60, name: '60.Kamandeka' },
      { id: 61, name: '61.Joglokerto' }
    ];
  }
  ...
  initializeCity() {
    this.cities = [
      ...
      { id: 46, name: '', train_id: 24, station_id: 0 },
      { id: 47, name: '', train_id: 24, station_id: 0 },
      { id: 48, name: '', train_id: 25, station_id: 0 },
      { id: 49, name: '', train_id: 25, station_id: 0 },
      { id: 50, name: '', train_id: 26, station_id: 0 },
      { id: 51, name: '', train_id: 26, station_id: 0 },
      { id: 52, name: '', train_id: 27, station_id: 0 },
      { id: 53, name: '', train_id: 27, station_id: 0 },
      { id: 54, name: '', train_id: 28, station_id: 0 },
      { id: 55, name: '', train_id: 28, station_id: 0 },
      { id: 56, name: '', train_id: 29, station_id: 0 },
      { id: 57, name: '', train_id: 29, station_id: 0 },
      { id: 58, name: '', train_id: 30, station_id: 0 },
      { id: 59, name: '', train_id: 30, station_id: 0 },
    ];
  }
