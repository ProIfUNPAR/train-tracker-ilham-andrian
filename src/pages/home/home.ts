...
export class HomePage {
  ...
  initializeStation() {
    ...
    this.stations = [
      ...
      { id: 11.3, name: 'Kutoarjo (KTA)', train_id: 49 },
      ...
      { id: '17.J', name: 'Jakarta Pasar Senen (PSE)', train_id: 51 },
      { id: '17.K', name: 'Jakarta Pasar Senen (PSE)', train_id: 52 },
      { id: '17.L', name: 'Jakarta Pasar Senen (PSE)', train_id: 54 },
      { id: '17.M', name: 'Jakarta Pasar Senen (PSE)', train_id: 58 },
      ...
      { id: 20.1, name: 'Semarang Poncol (SMC)', train_id: 55 },
      ...
      { id: 21.5, name: 'Semarang Tawang (SMT)', train_id: 49 },
      ...
      { id: 29.1, name: 'Semarang Poncol (SMC)', train_id: 50 },
      { id: 29.2, name: 'Semarang Poncol (SMC)', train_id: 55 },
      { id: 29.3, name: 'Semarang Poncol (SMC)', train_id: 56 },
    ];
  }
  ...
  initializeCity() {
    this.cities = [
      ...
      { id: 96, name: 'Lempuyangan(LPN)-Banyuwangi Baru(BW)', train_id: 49, station_id: 12.4 },
      { id: 97, name: 'Banyuwangi Baru(BW)-Lempuyangan(LPN)', train_id: 49, station_id: 2.2 },
      { id: 98, name: 'Semarang(SMC)-Jakarta(PSE)', train_id: 50, station_id: 29.1 },
      ...
      { id: 101, name: 'Bandung(KAC)-Kutoarjo(KTA)', train_id: 51, station_id: '17.J' },
      { id: 102, name: 'Tegal(TG)-Jakarta(PSE)', train_id: 52, station_id: 27.2 },
      { id: 103, name: 'Jakarta(PSE)-Tegal(TG)', train_id: 52, station_id: '17.K' },
      { id: 104, name: 'Banyuwangi Baru(BW)-Malang(MLK)', train_id: 53, station_id: 2.3 },
      { id: 105, name: 'Malang(MLK)-Banyuwangi Baru(BW)', train_id: 53, station_id: 15.1 },
      { id: 106, name: 'Tegal(TG)-Jakarta(PSE)', train_id: 54, station_id: 27.3 },
      { id: 107, name: 'Jakarta(PSE)-Tegal(TG)', train_id: 54, station_id: '17.L' },
      { id: 108, name: 'Surabaya(SBI)-Semarang(SMC)', train_id: 55, station_id: 26.6 },
      { id: 109, name: 'Semarang(SMC)-Surabaya(SBI)', train_id: 55, station_id: 20.1 },
      { id: 110, name: 'Purwosari(PWS)-Semarang(SMC)', train_id: 56, station_id: 19.3 },
      { id: 111, name: 'Semarang(SMC)-Purwosari(PWS)', train_id: 56, station_id: 20.2 },
      { id: 112, name: 'Surabaya(SB)-Banyuwangi Baru(BW)', train_id: 57, station_id: 25.1 },
      { id: 113, name: 'Banyuwangi Baru(BW)-Surabaya(SB)', train_id: 57, station_id: 2.4 },
      { id: 114, name: 'Purwokerto(PWT)-Jakarta(PSE)', train_id: 58, station_id: 18.2 },
      { id: 115, name: 'Jakarta(PSE)-Purwokerto(PWT)', train_id: 58, station_id: '17.M' },
